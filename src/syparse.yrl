...
contract_definition -> statement                                                                : '$1'.
...
%% ---------------------------------------------------------------------------------------------------------------------
variable_declaration -> elementary_type_name identifier                                         : {variableDeclaration, {typeName, '$1'}, '$2'}.
variable_declaration -> identifier identifier                                                   : {variableDeclaration, {typeName, '$1'}, '$2'}.

% wwe type_name -> elementary_type_name                                                               : {typeName, '$1'}.
...
mapping -> MAPPING '(' elementary_type_name '=>' elementary_type_name ')'                       : {mapping, '$3', {typeName, '$5'}}.
mapping -> MAPPING '(' elementary_type_name '=>' identifier ')'                                 : {mapping, '$3', {typeName, '$5'}}.

array_type_name -> type_name '[' expression_opt ']'                                             : {arrayTypeName, '$1', '$3'}.
array_type_name -> elementary_type_name '[' expression_opt ']'                                  : {arrayTypeName, {typeName, '$1'}, '$3'}.
array_type_name -> identifier '[' expression_opt ']'                                            : {arrayTypeName, {typeName, '$1'}, '$3'}.
...
var_def_or_expr_stmt -> expression_statement                                                    : {vardefOrExprStmt, '$1'}.

for_statement -> FOR '(' var_def_or_expr_stmt_opt ';' expression_opt ';' expression_statement_opt ')' statement
                                                                                                : {forStatement, '$3', '$5', '$7', '$9'}.

%% =====================================================================================================================
%% Helper definitions.
%% ---------------------------------------------------------------------------------------------------------------------
var_def_or_expr_stmt_opt -> '$empty'                                                            : [].
var_def_or_expr_stmt_opt -> var_def_or_expr_stmt                                                : '$1'.

expression_statement_opt -> '$empty'                                                            : [].
expression_statement_opt -> expression_statement                                                : '$1'.
%% ---------------------------------------------------------------------------------------------------------------------
...
return -> RETURN expression_opt                                                                 : {return, '$2'}.
...
expression -> unary_operation                                                                   : {expression, '$1'}.
expression -> binary_operation                                                                  : {expression, '$1'}.
...
%% Helper definitions.
%% ---------------------------------------------------------------------------------------------------------------------
expression -> identifier                                                                        : {expression, {primaryExpression, '$1'}}.
expression -> elementary_type_name                                                              : {expression, {primaryExpression, '$1'}}.
%% =====================================================================================================================

assignment -> expression assignment_op expression                                               : {assignment, '$1', '$2', '$3'}.

assignment_op -> ASSIGNMENT_OP                                                                  : {assignmentOp, unwrap('$1')}.

unary_operation -> unary_op expression                                                          : {unaryOperation, '$1', '$2'}.

unary_op -> UNARY_OP                                                                            : {unaryOp, unwrap('$1')}.
unary_op -> DELETE                                                                              : {unaryOp, "delete"}.

binary_operation -> expression binary_op expression                                             : {binaryOperation, '$1', '$2', '$3'}.

binary_op -> BINARY_OP                                                                          : {binaryOp, unwrap('$1')}.
...
index_access -> expression '[' expression_opt ']'                                               : {indexAccess, '$1', '$3'}.
...
%% Helper definitions: reduce/reduce conflict.
%% ---------------------------------------------------------------------------------------------------------------------
% wwe primary_expression -> elementary_type_name                                                      : {primaryExpression, '$1'}.
%% =====================================================================================================================

primary_expression -> '(' expression ')'                                                        : {primaryExpression, '$2', "("}.
